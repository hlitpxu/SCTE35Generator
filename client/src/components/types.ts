...
export namespace SEGMENTATION_TYPE_ID_NS {
	const sub_segment_type_ids = [
		...
		SEGMENTATION_TYPE_ID.PROVIDER_PROMO_START,
		SEGMENTATION_TYPE_ID.DISTRIBUTOR_PROMO_START,
		SEGMENTATION_TYPE_ID.PROVIDER_AD_BLOCK_START,
		SEGMENTATION_TYPE_ID.DISTRIBUTOR_AD_BLOCK_START,
	];
	...
	const zero_num_type_ids = [
		...
		SEGMENTATION_TYPE_ID.PROGRAM_IMMEDIATE_RESUMPTION,
...
export namespace SEGMENTATION_UPID_TYPE_NS {
	const lenth_limit_map = new Map([
		...
		[SEGMENTATION_UPID_TYPE.UUID, 16],
		[SEGMENTATION_UPID_TYPE.SCR, -1],
	])
